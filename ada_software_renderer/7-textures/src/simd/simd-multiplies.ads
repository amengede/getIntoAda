package Simd.Multiplies is
    ...
    function Multiply (A, B : Float32x2) return Float32x2 with
        Convention => Intrinsic,
        Import => True,
        External_Name => "float32x2_mul";
    ...
    -- returns A + B * C
    function Fused_Multiply_Add (A, B, C : Float32x2) return Float32x2 with
        Convention => Intrinsic,
        Import => True,
        External_Name => "float32x2_fmadd";
