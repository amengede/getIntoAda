...
package body Renderer is
    ...
    procedure Draw_Triangle (Triangle : Triangle_2D;
                             Color : Unsigned_32) is
        Triangle_Bounds : constant AABB := Enclose (Triangle);
        X_Min : constant Integer :=
            Integer'Max(0, Triangle_Bounds (0) (0));
        Y_Min : constant Integer :=
            Integer'Max(0, Triangle_Bounds (0) (1));
        X_Max : constant Integer :=
            Integer'Min(Width - 1, Triangle_Bounds (1) (0));
        Y_Max : constant Integer :=
            Integer'Min(Height - 1, Triangle_Bounds (1) (1));
        Pos : constant Point_2D := [X_Min, Y_Min];
        Weights : Point_3D := [0, 0, 0];
        Weights_Row : Point_3D :=
            [Signed_Area(Triangle (1), Triangle (2), Pos),
            Signed_Area(Triangle (2), Triangle (0), Pos),
            Signed_Area(Triangle (0), Triangle (1), Pos)];
        X_Partials : constant Point_3D :=
            [Triangle (1) (1) - Triangle (2) (1),
            Triangle (2) (1) - Triangle (0) (1),
            Triangle (0) (1) - Triangle (1) (1)];
        Y_Partials : constant Point_3D :=
