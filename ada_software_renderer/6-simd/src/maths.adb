...
package body Maths is
    ...
    function Enclose (Triangle : Triangle_2D) return AABB is
        Min_Corner_X : constant Integer_32 :=
            Integer_32'Min(Triangle (0) (0),
                        Integer_32'Min(Triangle (1) (0), Triangle (2) (0)));
        Min_Corner_Y : constant Integer_32 :=
            Integer_32'Min(Triangle (0) (1),
                        Integer_32'Min(Triangle (1) (1), Triangle (2) (1)));
        Max_Corner_X : constant Integer_32 :=
            Integer_32'Max(Triangle (0) (0),
                        Integer_32'Max(Triangle (1) (0), Triangle (2) (0)));
        Max_Corner_Y : constant Integer_32 :=
            Integer_32'Max(Triangle (0) (1),
                        Integer_32'Max(Triangle (1) (1), Triangle (2) (1)));
    begin
