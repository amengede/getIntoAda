...
package Renderer is
    ...
    -- Clear the screen
    -- @param Color Color to clear the screen with
    procedure Clear_Screen_SIMD (Color : Unsigned_32);

    -- Clear the screen
    -- @param Color Color to clear the screen with
    procedure Clear_Screen_Concurrent (Color : Unsigned_32);
...
private
    ...
    package Pixel_Data is
            new SDL.Video.Surfaces.Pixel_Data (
                                Element => Unsigned_32,
                                Element_Pointer => Pixel_Pointers.Pointer);

    type Pixel_Chunk_Array is array (Integer range <>)
        of aliased AVX2.Vector_256_U32;

    package Pixel_Chunk_Pointers is
            new Interfaces.C.Pointers (Index => Integer,
                                       Element => AVX2.Vector_256_U32,
                                       Element_Array => Pixel_Chunk_Array,
                                       Default_Terminator => [0, 0, 0, 0, 0, 0, 0, 0]);
    use type Pixel_Chunk_Pointers.Pointer;

    package Pixel_Chunk_Data is
        new SDL.Video.Surfaces.Pixel_Data (Element => AVX2.Vector_256_U32,
    ...
    Current_Chunk : AVX2.Vector_256_U32;
