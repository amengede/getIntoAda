...
package body Vulkan.Conditional_Rendering is
    ...
    procedure Begin_Conditional_Rendering
        (Command_Buffer: in Vulkan.Command_Buffer;
         Conditional_Rendering_Begin: in Conditional_Rendering_Begin_Info) is
        Info_C: Conditional_Rendering_C.Conditional_Rendering_Begin_Info_C :=
            Conditional_Rendering_C.To_C(Conditional_Rendering_Begin);
    begin
        vkCmdBeginConditionalRenderingEXT(Command_Buffer, Info_C);
        Conditional_Rendering_C.Free(Info_C);
...
end Vulkan.Conditional_Rendering;
