...
private package Vulkan.Video_Decode_H264_C is
    ...
    package Std_Video_H264_Sequence_Parameter_Set_Arrays is new C_Arrays
        (Std_Video_H264_Sequence_Parameter_Set);

    package Std_Video_H264_Picture_Parameter_Set_Arrays is new C_Arrays
    ...
    record
        ...
        Std_SPSs: Std_Video_H264_Sequence_Parameter_Set_Arrays.Pointer;
        Std_PPS_Count: Interfaces.Unsigned_32;
        Std_PPSs: Std_Video_H264_Picture_Parameter_Set_Arrays.Pointer;
    end record
        with Convention => C;
