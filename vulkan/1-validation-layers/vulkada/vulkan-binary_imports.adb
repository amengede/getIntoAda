...
package body Vulkan.Binary_Imports is
    -- Loaded extension functions.
    type vkCreateCuModuleNVX_Access is
        access function
            (Device: in Vulkan.Device;
             Create_Info: in Binary_Imports_C.Cu_Module_Create_Info_C;
    ...
    type vkCreateCuFunctionNVX_Access is
        access function
            (Device: in Vulkan.Device;
             Create_Info: in Binary_Imports_C.Cu_Function_Create_Info_C;
             Allocator: access constant Allocation_Callbacks;
    ...
    type vkDestroyCuFunctionNVX_Access is
        access procedure(Device: in Vulkan.Device;
                         Cu_Function: in Vulkan.Cu_Function;
                         Allocator: access constant Allocation_Callbacks)
        with Convention => C;
    ...
    type vkCmdCuLaunchKernelNVX_Access is
        access procedure(Command_Buffer: in Vulkan.Command_Buffer;
                         Launch_Info: in Binary_Imports_C.Cu_Launch_Info_C)
        with Convention => C;
    ...
    package Cu_Modules_Common is new Objects_Common_Access
        (Cu_Module_Create_Info,
         Binary_Imports_C.Cu_Module_Create_Info_C,
         Cu_Module,
         No_Cu_Module,
         Binary_Imports_C.To_C,
         Binary_Imports_C.Free,
    ...
    package Cu_Functions_Common is new Objects_Common_Access
        (Cu_Function_Create_Info,
         Binary_Imports_C.Cu_Function_Create_Info_C,
         Cu_Function,
         No_Cu_Function,
         Binary_Imports_C.To_C,
         Binary_Imports_C.Free,
    ...
    procedure Launch_Kernel(Command_Buffer: in Vulkan.Command_Buffer;
                            Launch_Info: in Cu_Launch_Info) is
        Info_C: Binary_Imports_C.Cu_Launch_Info_C :=
            Binary_Imports_C.To_C(Launch_Info);
    begin
        vkCmdCuLaunchKernelNVX(Command_Buffer, Info_C);
        Binary_Imports_C.Free(Info_C);
    end Launch_Kernel;
