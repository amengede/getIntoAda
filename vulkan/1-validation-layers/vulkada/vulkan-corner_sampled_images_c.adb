...
-- C interface for the corner sampled image extension

with Ada.Unchecked_Conversion;
with Vulkan.Utilities;
with Vulkan.Extension_Records;

package body Vulkan.Corner_Sampled_Images_C is
    procedure To_Ada
        (Ada_Struct: in out Physical_Device_Corner_Sampled_Image_Features;
            ...
            when Physical_Device_Corner_Sampled_Image_Features_Type =>
                declare
                    function Make_Struct is new Utilities.Make_Out_Struct
                        (Physical_Device_Corner_Sampled_Image_Features,
                ...
                declare
                    function To_Access is new Ada.Unchecked_Conversion
                       (C.Out_Structure_C_Access,
                        Physical_Device_Corner_Sampled_Image_Features_C_Access);
                begin
               To_Ada(Physical_Device_Corner_Sampled_Image_Features(Ada_Struct),
                      To_Access(Next).all);
                end;
        end case;
    end To_Ada;
...
end Vulkan.Corner_Sampled_Images_C;
