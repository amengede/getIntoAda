...
-- C interface for the present wait extension

with Ada.Unchecked_Conversion;
with Vulkan.Extension_Records;
with Vulkan.Utilities;

package body Vulkan.Present_Waits_C is
    procedure To_Ada(Ada_Struct: in out Physical_Device_Present_Wait_Features;
            ...
            when Physical_Device_Present_Wait_Features_Type =>
                declare
                    function Make_Struct is new Utilities.Make_Out_Struct
                        (Physical_Device_Present_Wait_Features,
                ...
                declare
                    function To_Access is new Ada.Unchecked_Conversion
                        (C.Out_Structure_C_Access,
                         Physical_Device_Present_Wait_Features_C_Access);
                begin
                    To_Ada(Physical_Device_Present_Wait_Features(Ada_Struct),
                           To_Access(Next).all);
                end;
        end case;
    end To_Ada;
