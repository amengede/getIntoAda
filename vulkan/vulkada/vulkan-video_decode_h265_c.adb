...
package body Vulkan.Video_Decode_H265_C is
    ...
    function To_C(Struct: in Video_Decode_H265_Session_Parameters_Add_Info)
        ...
        procedure To_C_Array is new Utilities.To_C_Array
            (Std_Video_H265_Video_Parameter_Set_Arrays,
             Std_Video_H265_Video_Parameter_Set_Vectors);

        procedure To_C_Array is new Utilities.To_C_Array
            (Std_Video_H265_Sequence_Parameter_Set_Arrays,
             Std_Video_H265_Sequence_Parameter_Set_Vectors);

        procedure To_C_Array is new Utilities.To_C_Array
            (Std_Video_H265_Picture_Parameter_Set_Arrays,
             Std_Video_H265_Picture_Parameter_Set_Vectors);
    ...
    begin
        Extension_Records.Free(Struct.Next);
        Std_Video_H265_Video_Parameter_Set_Arrays.Free(Struct.Std_VPSs);
        Std_Video_H265_Sequence_Parameter_Set_Arrays.Free(Struct.Std_SPSs);
        Std_Video_H265_Picture_Parameter_Set_Arrays.Free(Struct.Std_PPSs);
    end Free;
    ...
    begin
        ...
        case In_Structure(Next.Record_Type) is
            when Video_Decode_H265_Profile_Info_Type =>
                declare
                    function Make_Struct is new Utilities.Make_In_Struct
                        (Video_Decode_H265_Profile_Info,
            ...
            when Video_Decode_H265_Session_Parameters_Add_Info_Type =>
                declare
                    function Make_Struct is new Utilities.Make_In_Struct
                       (Video_Decode_H265_Session_Parameters_Add_Info,
                        Video_Decode_H265_Session_Parameters_Add_Info_C,
                        Video_Decode_H265_Session_Parameters_Add_Info_C_Access);
                begin
                    return Make_Struct(Next);
            ...
            when Video_Decode_H265_Session_Parameters_Create_Info_Type =>
                declare
                    function Make_Struct is new Utilities.Make_In_Struct
                    (Video_Decode_H265_Session_Parameters_Create_Info,
            ...
            when Video_Decode_H265_Capabilities_Type =>
                declare
                    function Make_Struct is new Utilities.Make_Out_Struct
                        (Video_Decode_H265_Capabilities,
                ...
                declare
                    function To_Access is new Ada.Unchecked_Conversion
                        (C.Out_Structure_C_Access,
                         Video_Decode_H265_Capabilities_C_Access);
                begin
                    To_Ada(Video_Decode_H265_Capabilities(Ada_Struct),
                           To_Access(Next).all);
                end;
        end case;
    end To_Ada;
