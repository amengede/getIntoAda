...
package body Vulkan.Debug_Utils is
    -- Loaded extension functions.
    type vkSetDebugUtilsObjectNameEXT_Access is
        access function
            (Device: in Vulkan.Device;
             Name_Info: in Debug_Utils_C.Debug_Utils_Object_Name_Info_C)
            return Result
        with Convention => C;
    ...
    type vkSetDebugUtilsObjectTagEXT_Access is
        access function
            (Device: in Vulkan.Device;
             Tag_Info: in Debug_Utils_C.Debug_Utils_Object_Tag_Info_C)
            return Result
        with Convention => C;
    ...
    type vkQueueBeginDebugUtilsLabelEXT_Access is
        access procedure(Queue: in Vulkan.Queue;
                         Label_Info: in Debug_Utils_C.Debug_Utils_Label_C)
        with Convention => C;
    ...
    type vkCreateDebugUtilsMessengerEXT_Access is
        access function
            (Instance: in Vulkan.Instance;
             Create_Info: in Debug_Utils_C.Debug_Utils_Messenger_Create_Info_C;
             Allocator: access constant Allocation_Callbacks;
             Messenger: in out Debug_Utils_Messenger) return Result
        with Convention => C;
    ...
    type vkDestroyDebugUtilsMessengerEXT_Access is
        access procedure(Instance: in Vulkan.Instance;
                         Messenger: in Debug_Utils_Messenger;
                         Allocator: access constant Allocation_Callbacks)
        with Convention => C;
    ...
    type vkSubmitDebugUtilsMessageEXT_Access is
        access procedure
            (Instance: in Vulkan.Instance;
             ...
             Callback_Data:
                in Debug_Utils_C.Debug_Utils_Messenger_Callback_Data_C)
        with Convention => C;
    ...
    package Debug_Marshallers is
        new Callback_Marshallers(Debug_Utils_Messenger,
    ...
    function Callback_Proxy
        (Message_Severity: in Debug_Utils_Message_Severity_Flags;
         Message_Types: in Debug_Utils_Message_Type_Flags;
         Callback_Data: in Debug_Utils_C.Debug_Utils_Messenger_Callback_Data_C;
    ...
    function Set_Object_Name(Device: in Vulkan.Device;
        ...
        return Result is
        Name_Info_C: Debug_Utils_C.Debug_Utils_Object_Name_Info_C :=
            Debug_Utils_C.To_C(Name_Info);
        Result: Vulkan.Result;
    begin
        Result := vkSetDebugUtilsObjectNameEXT(Device, Name_Info_C);
        Debug_Utils_C.Free(Name_Info_C);

        return Result;
    end Set_Object_Name;

    procedure Set_Object_Name(Device: in Vulkan.Device;
                              Name_Info: in Debug_Utils_Object_Name_Info) is
    begin
    ...
    function Set_Object_Tag(Device: in Vulkan.Device;
        ...
        return Result is
        Tag_Info_C: Debug_Utils_C.Debug_Utils_Object_Tag_Info_C :=
            Debug_Utils_C.To_C(Tag_Info);
        Result: Vulkan.Result;
    begin
        Result := vkSetDebugUtilsObjectTagEXT(Device, Tag_Info_C);
        Debug_Utils_C.Free(Tag_Info_C);

        return Result;
    end Set_Object_Tag;

    procedure Set_Object_Tag(Device: in Vulkan.Device;
                             Tag_Info: in Debug_Utils_Object_Tag_Info) is
    begin
        Exceptions.Check(Set_Object_Tag(Device, Tag_Info));
    end Set_Object_Tag;

    procedure Queue_Begin_Label(Queue: in Vulkan.Queue;
                                Label_Info: in Debug_Utils_Label) is
        Label_Info_C: Debug_Utils_C.Debug_Utils_Label_C :=
            Debug_Utils_C.To_C(Label_Info);
    begin
        vkQueueBeginDebugUtilsLabelEXT(Queue, Label_Info_C);
        Debug_Utils_C.Free(Label_Info_C);
    ...
    function Create(Instance: in Vulkan.Instance;
                    ...
                    Messenger: out Debug_Utils_Messenger) return Result is
    begin
    ...
    begin
        if Messenger /= No_Debug_Utils_Messenger then
    ...
    procedure Destroy(Instance: in Vulkan.Instance;
                      Messenger: in out Debug_Utils_Messenger) is
    begin
        if Messenger /= No_Debug_Utils_Messenger then
            Marshallers.Remove(Messenger);
    ...
    procedure Submit_Message
        (Instance: in Vulkan.Instance;
         Message_Severity: in Debug_Utils_Message_Severity_Flags;
         Message_Types: in Debug_Utils_Message_Type_Flags;
         Callback_Data: in Debug_Utils_Messenger_Callback_Data) is
        Callback_Data_C: Debug_Utils_C.Debug_Utils_Messenger_Callback_Data_C :=
            Debug_Utils_C.To_C(Callback_Data);
    begin
        vkSubmitDebugUtilsMessageEXT(Instance,
                                     Message_Severity,
                                     Message_Types,
                                     Callback_Data_C);
        Debug_Utils_C.Free(Callback_Data_C);
    end Submit_Message;
    ...
    function Create(Instance: in Vulkan.Instance;
                    ...
                    Allocator: access constant Allocation_Callbacks;
                    Messenger: out Debug_Utils_Messenger) return Result is
        Create_Info_C: Debug_Utils_C.Debug_Utils_Messenger_Create_Info_C :=
            Debug_Utils_C.To_C(Create_Info);
        Result: Vulkan.Result;
    ...
    begin
        ...
        Result := vkCreateDebugUtilsMessengerEXT(Instance,
                                                 ...
                                                 Allocator,
                                                 Messenger);
        Debug_Utils_C.Free(Create_Info_C);
    ...
    function Callback_Proxy
        ...
        package Debug_Utils_Label_C_Pointers is
            new Interfaces.C.Pointers
                (Positive,
                 Debug_Utils_C.Debug_Utils_Label_C,
                 Debug_Utils_C.Debug_Utils_Label_C_Arrays.Element_Array,
                 (Next => null,
        ...
        package Debug_Utils_Object_Name_Info_C_Pointers is
            new Interfaces.C.Pointers
            (Positive,
             Debug_Utils_C.Debug_Utils_Object_Name_Info_C,
             Debug_Utils_C.Debug_Utils_Object_Name_Info_C_Arrays.Element_Array,
             (Next => null,
        ...
        function To_Ada(Label: in Debug_Utils_C.Debug_Utils_Label_C)
            return Debug_Utils_Label is
            Label_Ada: Debug_Utils_Label;
        begin
        ...
        function To_Ada(Name_Info:
                            in Debug_Utils_C.Debug_Utils_Object_Name_Info_C)
            return Debug_Utils_Object_Name_Info is
            Name_Info_Ada: Debug_Utils_Object_Name_Info;
        begin
        ...
        function To_Pointer is new Ada.Unchecked_Conversion
            (Debug_Utils_C.Debug_Utils_Label_C_Arrays.Pointer,
             Debug_Utils_Label_C_Pointers.Pointer);

        function To_Pointer is new Ada.Unchecked_Conversion
            (Debug_Utils_C.Debug_Utils_Object_Name_Info_C_Arrays.Pointer,
             Debug_Utils_Object_Name_Info_C_Pointers.Pointer);

        Marshaller: Debug_Marshallers.Marshaller_Access :=
            Debug_Marshallers.To_Marshaller(User_Data);
        Callback_Data_Ada: Debug_Utils_Messenger_Callback_Data;
    begin
