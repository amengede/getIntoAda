...
package body Vulkan.Ray_Tracing_Maintenance_1_C is
    procedure To_Ada
        ...
        case Structure(Next.Record_Type) is
            when Physical_Device_Ray_Tracing_Maintenance_1_Features_Type =>
                declare
                  ...
                  (Physical_Device_Ray_Tracing_Maintenance_1_Features,
    ...
    begin
        case Structure(Ada_Struct.Record_Type) is
            when Physical_Device_Ray_Tracing_Maintenance_1_Features_Type =>
                ...
                begin
                    To_Ada
                (Physical_Device_Ray_Tracing_Maintenance_1_Features(Ada_Struct),
                 To_Access(Next).all);
                end;
        end case;
    end To_Ada;
