...
package Vulkan.Image_View_Handles is
    ...
    function Get_Image_View_Address
        (Device: in Vulkan.Device;
         ...
         Properties: in out Image_View_Address_Properties) return Result
