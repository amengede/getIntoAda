...
-- C interface for the fragment shader barycentric extension

with Ada.Unchecked_Conversion;
with Vulkan.Utilities;
with Vulkan.Extension_Records;

package body Vulkan.Fragment_Shader_Barycentrics_C is
    procedure To_Ada
        (Ada_Struct: in out
            Physical_Device_Fragment_Shader_Barycentric_Features;
    ...
    procedure To_Ada
        (Ada_Struct: in out
            Physical_Device_Fragment_Shader_Barycentric_Properties;
         C_Struct:
    ...
    begin
        case Structure(Ada_Struct.Record_Type) is
            when Physical_Device_Fragment_Shader_Barycentric_Features_Type =>
                ...
                begin
                    To_Ada
              (Physical_Device_Fragment_Shader_Barycentric_Features(Ada_Struct),
               To_Access(Next).all);
                end;
            when Physical_Device_Fragment_Shader_Barycentric_Properties_Type =>
                declare
              ...
              (C.Out_Structure_C_Access,
               Physical_Device_Fragment_Shader_Barycentric_Properties_C_Access);
                begin
                    To_Ada
            (Physical_Device_Fragment_Shader_Barycentric_Properties(Ada_Struct),
             To_Access(Next).all);
                end;
        end case;
    end To_Ada;
...
end Vulkan.Fragment_Shader_Barycentrics_C;
