...
-- C interface for the ray tracing position fetch extension

with Ada.Unchecked_Conversion;
with Vulkan.Utilities;
with Vulkan.Extension_Records;

package body Vulkan.Ray_Tracing_Position_Fetches_C is
    procedure To_Ada
        (Ada_Struct: in out Physical_Device_Ray_Tracing_Position_Fetch_Features;
        ...
        case Structure(Next.Record_Type) is
            when Physical_Device_Ray_Tracing_Position_Fetch_Features_Type =>
                declare
                 ...
                 (Physical_Device_Ray_Tracing_Position_Fetch_Features,
    ...
    begin
        case Structure(Ada_Struct.Record_Type) is
            when Physical_Device_Ray_Tracing_Position_Fetch_Features_Type =>
                ...
                begin
                    To_Ada
                (Physical_Device_Ray_Tracing_Position_Fetch_Features(Ada_Struct),
                 To_Access(Next).all);
                end;
        end case;
    end To_Ada;
...
end Vulkan.Ray_Tracing_Position_Fetches_C;
