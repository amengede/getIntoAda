...
package body Vulkan.Deferred_Host_Operations is
    ...
    function Create(Device: in Vulkan.Device) return Deferred_Operation is
        Operation: Deferred_Operation;
    begin
    ...
    begin
        ...
        Operation := No_Deferred_Operation;
    end Destroy;

    procedure Destroy(Device: in Vulkan.Device;
                      Operation: in out Deferred_Operation) is
    begin
    ...
    function Get_Result(Device: in Vulkan.Device;
                        Operation: in Deferred_Operation) return Result is
    begin
