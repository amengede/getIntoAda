...
package Vulkan.Extensions.KHR_Maintenance_6 is
    ...
    procedure Bind
        (Command_Buffer: in Vulkan.Command_Buffer;
         Bind_Descriptor_Sets_Info: in KHR.Bind_Descriptor_Sets_Info)
    ...
    procedure Push(Command_Buffer: in Vulkan.Command_Buffer;
                   Push_Constants_Info: in KHR.Push_Constants_Info)
        with Pre => Command_Buffer /= No_Command_Buffer and
    ...
    procedure Push(Command_Buffer: in Vulkan.Command_Buffer;
                   Push_Descriptor_Set_Info: in KHR.Push_Descriptor_Set_Info)
        with Pre => Command_Buffer /= No_Command_Buffer and
    ...
    procedure Push
        (Command_Buffer: in Vulkan.Command_Buffer;
         Push_Descriptor_Set_With_Template_Info:
            in KHR.Push_Descriptor_Set_With_Template_Info)
        with Pre =>
