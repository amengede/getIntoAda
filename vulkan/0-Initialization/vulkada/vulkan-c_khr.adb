...
package body Vulkan.C_KHR is
   ...
   Extensions.KHR.Physical_Device_Shader_Subgroup_Uniform_Control_Flow_Features;
    ...
    procedure To_Ada
        (Ada_Struct:
            in out Extensions.KHR.Physical_Device_Maintenance_5_Features;
    ...
    function To_C
        ...
        procedure To_C_Array is new Utilities.To_C_Array
            (Vertex_Input_Binding_Divisor_Description_Arrays,
             Extensions.KHR.Vertex_Input_Binding_Divisor_Description_Vectors);
    ...
    function To_C(Struct: in Extensions.KHR.Bind_Memory_Status)
        return Bind_Memory_Status_C is
    ...
    begin
        ...
        case In_Structure(Next.Record_Type) is
            ...
            when Device_Queue_Global_Priority_Create_Info_Type =>
                declare
                    function Make_Struct is new Utilities.Make_In_Struct
                       (Extensions.KHR.Device_Queue_Global_Priority_Create_Info,
            ...
            when Rendering_Attachment_Location_Info_Type =>
                declare
                    function Make_Struct is new Utilities.Make_In_Struct
                        (Extensions.KHR.Rendering_Attachment_Location_Info,
            ...
            when Rendering_Input_Attachment_Index_Info_Type =>
                declare
                    function Make_Struct is new Utilities.Make_In_Struct
                        (Extensions.KHR.Rendering_Input_Attachment_Index_Info,
            ...
            when Memory_Map_Info_Type =>
                declare
                    function Make_Struct is new Utilities.Make_In_Struct
                        (Extensions.KHR.Memory_Map_Info,
                         Memory_Map_Info_C,
            ...
            when Memory_Unmap_Info_Type =>
                declare
                    function Make_Struct is new Utilities.Make_In_Struct
                        (Extensions.KHR.Memory_Unmap_Info,
                         Memory_Unmap_Info_C,
            ...
            when Rendering_Area_Info_Type =>
                declare
                    function Make_Struct is new Utilities.Make_In_Struct
                        (Extensions.KHR.Rendering_Area_Info,
            ...
            when Device_Image_Subresource_Info_Type =>
                declare
                    function Make_Struct is new Utilities.Make_In_Struct
                        (Extensions.KHR.Device_Image_Subresource_Info,
            ...
            when Pipeline_Create_Flags_2_Create_Info_Type =>
                declare
                    function Make_Struct is new Utilities.Make_In_Struct
                        (Extensions.KHR.Pipeline_Create_Flags_2_Create_Info,
            ...
            when Buffer_Usage_Flags_2_Create_Info_Type =>
                declare
                    function Make_Struct is new Utilities.Make_In_Struct
                        (Extensions.KHR.Buffer_Usage_Flags_2_Create_Info,
            ...
            when Pipeline_Vertex_Input_Divisor_State_Create_Info_Type =>
                declare
                    function Make_Struct is new Utilities.Make_In_Struct
                (Extensions.KHR.Pipeline_Vertex_Input_Divisor_State_Create_Info,
            ...
            when Bind_Memory_Status_Type =>
                declare
                    function Make_Struct is new Utilities.Make_In_Struct
                        (Extensions.KHR.Bind_Memory_Status,
            ...
            when Bind_Descriptor_Sets_Info_Type =>
                declare
                    function Make_Struct is new Utilities.Make_In_Struct
                        (Extensions.KHR.Bind_Descriptor_Sets_Info,
            ...
            when Push_Constants_Info_Type =>
                declare
                    function Make_Struct is new Utilities.Make_In_Struct
                        (Extensions.KHR.Push_Constants_Info,
            ...
            when Push_Descriptor_Set_Info_Type =>
                declare
                    function Make_Struct is new Utilities.Make_In_Struct
                        (Extensions.KHR.Push_Descriptor_Set_Info,
            ...
            when Push_Descriptor_Set_With_Template_Info_Type =>
                declare
                    function Make_Struct is new Utilities.Make_In_Struct
                        (Extensions.KHR.Push_Descriptor_Set_With_Template_Info,
    ...
    begin
        ...
        case Out_Structure(Next.Record_Type) is
            ...
            when Physical_Device_Push_Descriptor_Properties_Type =>
                declare
                    function Make_Struct is new Utilities.Make_Out_Struct
                     (Extensions.KHR.Physical_Device_Push_Descriptor_Properties,
            ...
            when Queue_Family_Global_Priority_Properties_Type =>
                declare
                    function Make_Struct is new Utilities.Make_Out_Struct
                        (Extensions.KHR.Queue_Family_Global_Priority_Properties,
          ...
          (Extensions.KHR.Physical_Device_Shader_Maximal_Reconvergence_Features,
           ...
           Physical_Device_Shader_Maximal_Reconvergence_Features_C_Access);
            ...
            when Physical_Device_Maintenance_5_Features_Type =>
                declare
                    function Make_Struct is new Utilities.Make_Out_Struct
                        (Extensions.KHR.Physical_Device_Maintenance_5_Features,
            ...
            when Physical_Device_Maintenance_5_Properties_Type =>
                declare
                    function Make_Struct is new Utilities.Make_Out_Struct
                       (Extensions.KHR.Physical_Device_Maintenance_5_Properties,
            ...
            when Image_Subresource_2_Type =>
                declare
                    function Make_Struct is new Utilities.Make_Out_Struct
                        (Extensions.KHR.Image_Subresource_2,
            ...
            when Subresource_Layout_2_Type =>
                declare
                    function Make_Struct is new Utilities.Make_Out_Struct
                        (Extensions.KHR.Subresource_Layout_2,
            ...
            when Physical_Device_Maintenance_6_Features_Type =>
                declare
                    function Make_Struct is new Utilities.Make_Out_Struct
                        (Extensions.KHR.Physical_Device_Maintenance_6_Features,
            ...
            when Physical_Device_Maintenance_6_Properties_Type =>
                declare
                    function Make_Struct is new Utilities.Make_Out_Struct
                       (Extensions.KHR.Physical_Device_Maintenance_6_Properties,
                ...
                declare
                    function To_Access is new Ada.Unchecked_Conversion
                        (C.Out_Structure_C_Access,
                         Queue_Family_Global_Priority_Properties_C_Access);
                begin
                   To_Ada(Extensions.KHR.Queue_Family_Global_Priority_Properties
                           (Ada_Struct),
                          To_Access(Next).all);
                end;
            when Physical_Device_Fragment_Shading_Rate_Features_Type =>
                ...
                declare
                    function To_Access is new Ada.Unchecked_Conversion
                        (C.Out_Structure_C_Access,
                         Physical_Device_Maintenance_5_Features_C_Access);
                begin
                    To_Ada(Extensions.KHR.Physical_Device_Maintenance_5_Features
                            (Ada_Struct),
                           To_Access(Next).all);
                end;
            when Physical_Device_Maintenance_5_Properties_Type =>
                ...
                declare
                    function To_Access is new Ada.Unchecked_Conversion
                        (C.Out_Structure_C_Access,
                         Image_Subresource_2_C_Access);
                begin
                    To_Ada(Extensions.KHR.Image_Subresource_2(Ada_Struct),
                           To_Access(Next).all);
                end;
            when Subresource_Layout_2_Type =>
                declare
                    function To_Access is new Ada.Unchecked_Conversion
                        (C.Out_Structure_C_Access,
                         Subresource_Layout_2_C_Access);
                begin
                    To_Ada(Extensions.KHR.Subresource_Layout_2(Ada_Struct),
                           To_Access(Next).all);
                end;
            when Physical_Device_Ray_Tracing_Position_Fetch_Features_Type =>
                declare
                ...
                declare
                    function To_Access is new Ada.Unchecked_Conversion
                        (C.Out_Structure_C_Access,
                         Physical_Device_Maintenance_6_Features_C_Access);
                begin
                    To_Ada(Extensions.KHR.Physical_Device_Maintenance_6_Features
                            (Ada_Struct),
                           To_Access(Next).all);
                end;
            when Physical_Device_Maintenance_6_Properties_Type =>
