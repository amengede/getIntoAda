...
package body Meshes is
    function Make_RGB_Triangle return Mesh is
        ...
        Indices : constant Index_Data (0 .. 2) :=
            [0, 1, 2];
        Final_Mesh : Mesh;
        Vertex_Stride : constant := 17;
        Vertex_Buffer_Size : constant := 3 * Vertex_Stride;
        Index_Buffer_Size : constant := 3;
        Buffer_Size : constant Types.Long :=
    ...
    begin
        ...
        Final_Mesh.Index_Buffer_Offset := Vertex_Buffer_Size;
        ...
        Attributes.Enable_Vertex_Attrib_Array (2);
        Attributes.Set_Vertex_Attrib_Pointer (Index => 2,
                                            Count => 2,
                                            Kind => Single_Type,
                                            Normalized => False,
                                            Stride => Vertex_Stride,
