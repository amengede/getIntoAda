...
package body Renderer is
    ...
    begin
        ...
        Texture := Materials.From_Image (
            Filename => "img/resident-evil-4-absolute-cinema.png");
    end Initialize;
    ...
    begin
        ...
        Buffers.Draw_Elements (
            Mode => Triangles,
            Count => Triangle_Mesh.Index_Count,
            Index_Type => UByte_Type,
            Element_Offset => Triangle_Mesh.Index_Buffer_Offset);
    end Draw;
