...
package body Vectors is
   ...
   begin
      ...
      if Self.Data = null then
         raise Uninitialized_Exception with "Trying to access empty vector";
      end if;

      if Index >= Self.Data.Size then
         raise Out_Of_Bounds_Exception with "Accessing beyond end of vector";
      end if;
   ...
   begin
      if Self.Data = null then
         raise Uninitialized_Exception with "Trying to erase from empty vector";
      end if;

      if Index >= Self.Data.Size then
         raise Out_Of_Bounds_Exception with "Erasing beyond end of vector";
      end if;

      Self.Data.Elements (Index) := Self.Data.Elements (Self.Data.Size - 1);
      Self.Data.Size := Self.Data.Size - 1;
   end Erase;
   ...
   begin
      if Self.Data = null then
         raise Uninitialized_Exception with "Trying to clear empty vector";
      end if;
   ...
   function Get_Capacity (Self : in out Vector) return Natural is
   begin
      if Self.Data = null then
         return 0;
      end if;
   ...
   function Get_Size (Self : in out Vector) return Natural is
   begin
      if Self.Data = null then
         return 0;
      end if;
